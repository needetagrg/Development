const Category = () => {
    return (
      ...
      <div className="flex items-center m-3">
        ...
        {/* Serum */}
        <div className="relative bg-[url('/serum2.jpeg')] bg-no-repeat bg-cover bg-center bg-slate-300 h-[500px] w-[400px] flex items-center justify-center m-[20px] rounded-lg">
          <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent">
            <div className="relative flex items-center justify-center h-full">
